...
import {
  apiLlamadaMecanico,
  apiSegundaLlamadaMecanico,
} from "../../../api/Servicios/Twilio/Twilio";
...
const ModalRegistrarServicio = ({
  ...
  const handleSaveServicio = (e) => {
    ...
    const servicioNew = {
      mecanico:
        servicioNuevo?.mecanico != undefined
          ? Number(servicioNuevo?.mecanico)
          : null,
    ...
    apiSaveServicios(servicioNew)
      ...
      .then((data) => {
        ...
        if (data.success) {
          ...
          // if (data.data.mecanico !== null) {
          //   segundaLlamadaMecanico(data.data);
          // }
          toggle();
          iniciarCronometro(data.data);
  ...
  const handleSaveServicioLimpiezaInyectores = (e) => {
    ...
    const servicioNew = {
      mecanico:
        servicioNuevoLimpieza?.mecanico != undefined
          ? Number(servicioNuevoLimpieza?.mecanico)
          : null,
  ...
  const segundaLlamadaMecanico = (servicio) => {
    console.log("Llamada mecancio");
    apiSegundaLlamadaMecanico(servicio)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
        if (data.success) {
