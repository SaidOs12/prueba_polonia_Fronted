...
const ModalRegistrarPago = ({
  ...
  const [optionPago, setOptionPago] = useState([]);
  ...
  const handleSavePago = (e) => {
    ...
    const metodoPago = {
      ...
      tipoPago: buscarTipoPago(metodoPagoNew.tipoPago),
    };
   setDownloading(true);
  ...
  const buscarTipoPago = (id) => {
    ...
    const pago = tipoPagos.find((tipo) => tipo.id == id);
    return pago; // Devolvemos el objeto encontrado, o undefined si no se encontró ninguna coincidencia
  };
